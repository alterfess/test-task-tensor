...
class SeleniumBase:
    """Base class for using selenium present and visible function with BY locators """
    def __init__(self, driver):
        self.driver = driver
        self.__wait = WebDriverWait(driver, 15, 0.1)

    def __get_selenium_by(self, find_by: str) -> dict:
        """Function for return BY.LOCATOR using locators name"""
